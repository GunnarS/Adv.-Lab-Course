...
\end{figure}
Because of the \textsc{Malus} law we expect a quadratic relation between the two values and therefore fit a function of the form
\begin{align}
...
\caption{Power of the second harmonic generation for different rotation angles of the $\lambda / 2$ plate, with corresponding fundamental wave power}
