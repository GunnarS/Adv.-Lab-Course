...
Because a length is not measured properly, the theoretical spectral resolution of the grating has a relatively big error and is significantly higher than our experimentational result, which also has a large uncertainty. Nevertheless our results seem to be meaningful.
