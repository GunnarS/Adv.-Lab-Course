...
\begin{figure}[H]
  ...
  \label{fig:linbo}
\end{figure}
As one can see, the \linbo crystal consists of planar sheets of oxygen atoms in a distorted hexagonal close-packed configuration. Furthermore the interstices are occupied one-third by lithium ions, one-third by niobium ions and one-third vacant. The order is depicted in the figure above.
